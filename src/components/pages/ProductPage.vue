<template>
  <div>
    <div v-if="this.productLoading" class="cssload-thecube">
      <div class="cssload-cube cssload-c1"></div>
      <div class="cssload-cube cssload-c2"></div>
      <div class="cssload-cube cssload-c4"></div>
      <div class="cssload-cube cssload-c3"></div>
    </div>
    <div v-else-if="!this.productData">Произошла ошибка при загрузке товаров
      <button @click.prevent="loadProduct">Попробовать снова</button>
    </div>
        ...
        <div class="item__info">
          ...
          <div class="item__form">
            <form class="form" action="#" method="POST" @submit.prevent="addToCart()">
              ...
              <div class="item__row">
                <AmountChanger :product-amount.sync="productAmount"/>
        ...
        <div class="item__desc">
          ...
          <div class="item__content">
            ...
            <p>
              ...
              различные приложения сторонних разработчиков.
            ...
            <p>
              ...
              составляют всего 74,6 x 47,3 x 22,1 мм.
              что не превышает габариты смартфона. Корпус гаджета выполнен из
              черного пластика. На обращенной к
              ...
              влаги IPX7. Это означает, что устройство не боится пыли, а также
              выдерживает кратковременное (до 30 минут)
...
import AmountChanger from '../base/AmountChanger.vue';
